...
# Ocean Media Content Intelligence Service
endpoint = os.getenv("CONTENTUNDERSTANDING_ENDPOINT")
key = os.getenv("CONTENTUNDERSTANDING_KEY")

# sample document
formUrlGithub = "https://raw.githubusercontent.com/Azure-Samples/cognitive-services-REST-api-samples/master/curl/form-recognizer/invoice_sample.jpg"
formUrlOChoa ="https://sthubleovirg371723224242.blob.core.windows.net/d1302f6f-0560-4289-964f-a6d75dca272d-azureml-blobstore/UI/2026-01-23_220707_UTC/Invoice_RT%235006-1_2026-02-05.pdf"
formUrlsimx ="https://sthubleovirg371723224242.blob.core.windows.net/d1302f6f-0560-4289-964f-a6d75dca272d-azureml-blobstore/UI/2026-01-23_225443_UTC/custinvc PDF _Thu Oct 03 2024 10_38_02 GMT-0700 (PDT).pdf"
formUrlazure ="https://sthubleovirg371723224242.blob.core.windows.net/d1302f6f-0560-4289-964f-a6d75dca272d-azureml-blobstore/UI/2026-01-23_231519_UTC/adswhizz.pdf"
...
print("Content Understanding Analysis Result:")
for page in result.pages:
    print(f"Page {page.page_number}:")
    print(f"  Text: {page.content}")
    print(f"  Width: {page.width}, Height: {page.height}, Unit: {page.unit}")
    print("  Lines:")
    for line in page.lines:
        print(f"    {line.content} (Bounding Box: {line.bounding_box})")
    print("  Words:")
    for word in page.words:
        print(f"    {word.content} (Confidence: {word.confidence})")
    print()

# Document Intelligence Client section
